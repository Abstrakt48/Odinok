...
//
// Vector2D
// Used for 2D math stuff (pathfinding and stuff)
//
class Vector2D
{
public:
...
inline float _DotProduct(const Vector2D& a, const Vector2D& b) { float toReturn; toReturn = (a.x * b.x + a.y * b.y); return toReturn; }
...
// For 3D math stuff
//
class Vector						// same data-layout as mathlib's Vector,
{									//		which is a vec_t[3]
public:
...
inline float _DotProduct(const Vector& a, const Vector& b) { return(a.x * b.x + a.y * b.y + a.z * b.z); }
